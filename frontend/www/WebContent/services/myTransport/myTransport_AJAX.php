			...
			<form method="get" action="#">
				...
				<table>
				 <tr>
				    <th>*When : </th>
				    <td>
				    	<input id="when11" type="text" value="jj" size="2" MAXLENGTH="2"/>/
				    	<input id="when12" type="text" value="mm" size="2" MAXLENGTH="2"/>/
				    	<input id="when13" type="text" value="aaaa" size="4" MAXLENGTH="4"/>
				    </td>
				  </tr>
				  <tr>
				    <th>*From : </th>
				    <td><input id="from1" type="text" /></td>
				  </tr>
				  <tr>
				    <th>*To : </th>
				    <td><input id="to1" type="text" /></td>
				  </tr>
				  <tr>
				    <th><input type="button" onclick="submitForm('search')" value="Search" /></th>
				  </tr>
				</table>
			</form>
