<?php 
	if($_GET["code"] == "search"){
		...
		$id = file_get_contents("http://mymed2.sophia.inria.fr:8084/services/RequestHandler?act=5&key2=" . $key);
		$description = file_get_contents("http://mymed2.sophia.inria.fr:8084/services/RequestHandler?act=5&key2=" . $key);
		$bool = true;
		$search = true;	
