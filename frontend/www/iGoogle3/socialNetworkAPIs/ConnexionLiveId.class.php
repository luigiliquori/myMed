<?php
require_once dirname(__FILE__).'/ConnexionOAuth2_0.class.php';
/**
...
class ConnexionLiveId extends ConnexionOAuth2_0
{
	...
	protected	/*string*/	function getOAuthConsumerId(){return '000000004405611F';}
	protected	/*string*/	function getOAuthConsumerSecret(){return 'Akxh3kwLGjkyKpjpfBShzk9wrDAjme94';}
	...
	protected /*void*/ function getDatas($access_token)
	{
		...
		$_SESSION['user']->mymedID			= static::getSocialNetwork().$user->id;
