...
require_once dirname(__FILE__).'/handler/MyCARFHandler.class.php';
 ...
 *
 */
abstract class MyCARF extends AbstractTemplate {
	...
	public function __construct(/*String*/ $id) {
		parent::__construct($id, "myCARF");
		$this->activeFooter = $id;
		$this->handler = new MyCARFHandler();
