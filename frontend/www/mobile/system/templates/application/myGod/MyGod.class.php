...
require_once dirname(__FILE__).'/handler/MyGodHandler.class.php';
 ...
 *
 */
abstract class MyGod extends AbstractTemplate {
	
	/* --------------------------------------------------------- */
	/* Attributes */
	/* --------------------------------------------------------- */
	private /*String*/ $activeFooter;
	private /*MyGodHandler*/ $handler;
	...
	public function __construct(/*String*/ $id) {
		parent::__construct($id, "MyGod");
		$this->activeFooter = $id;
		$this->handler = new MyGodHandler();
	...
	public /*String*/ function getHeader() { ?>
		...
		<?php if($this->handler->getError()) { ?>
			<div data-role="header" data-theme="a">
				<a href="?application=MyGod" data-role="button" rel="external">Close</a>
				<h2>No Result</h2>
			</div>
		<?php } else { ?>
