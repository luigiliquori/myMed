...
?><a href="?connexion=openid&amp;connexionProvider=<?=urlencode($this->social_network)?>&amp;oidUri=<?=static::getProviderUrl()?><?=htmlspecialchars($query_string)?>" class="<?=preg_replace('#[^a-z0-9]#','',strtolower($this->social_network))?>"><span><?= $this->social_network?></span></a><?php
	}
}
?>
