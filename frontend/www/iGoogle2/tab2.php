<div id="tab2" style="display: none;">
	<table style="position:absolute; top:152px; left: 0px;">
	  <tr>
	    ...
	    <td><div class="tab" style="width: 148px;background-image: url('img/tab/tabOn.png');"><a href="#" style="position:relative; top:3px;" onclick="cleanView(); fadeIn('#tab2');">Pratique</a></div></td>
