...
class ExtendedProfileRequired extends GuestController {
	...
	public function handleRequest(){
		...
		if (!isset($_SESSION['myEuroCIN'], $_SESSION['myEuroCIN']->permission)) {
			...
			if (isset($usr)) {
				...
				$profile = new myEuroCINProfile($usr['profile']);
				try {
				...
				if (isset($profile->details)){
					...
					$_SESSION['myEuroCIN'] = (object) array_merge( $usr, (array) $profile);
