...
session_start();
$_SESSION['appliName'] = APPLICATION_NAME; // used in order to access to the name of the current application for the redirection when log in with socialNetworks
