 ...
 * @param string $back_button_label the back button label
 */
function print_header_bar($back_button = false, $idHelpPopup = "defaultHelpPopup", $title, $back_button_label = 'back') {
