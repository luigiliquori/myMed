...
class LocalisationView {
	...
	public /*String*/ function getDetails() { ?>
			<div id="roadMap" data-role="page" data-theme="a" >
	...
	public /*String*/ function getPosition() { ?>
			...
			<div data-role="header" data-theme="a" data-position="fixed" style="max-height:40px;">
				<h1><a href="#Map" onclick="window.scrollTo(0,40);" style="font-weight: bold;color:white; text-decoration:none;margin-left: 18px;"><?= APPLICATION_NAME ?></a></h1>
	...
	public /*String*/ function getSearching() { 
		...
		<div id="Itin" data-theme="a">
			<form action="" name="<?= APPLICATION_NAME ?>FindForm"
				...
				<!-- FROM -->
				Départ :
				<input data-theme="a" type="text" id="depart" name="Depart" />
				<br />
				
				<!-- TO -->
				Arrivée :
				<input data-theme="a" type="text" id="arrivee" name="Arrivee" />
				<!-- FRIENDS -->
