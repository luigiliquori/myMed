...
<div id="home" data-role="page" data-dom-cache="true">
	...
	<div data-role="content">
		...
		<form action="<?= url("main:generateGraph");?>" method="post" data-ajax="false">
			<div data-role="fieldcontain">
				<fieldset data-role="controlgroup" data-type="horizontal">
					...
					<!-- Validate button -->
					<input type="submit" data-inline="true" data-role="button" value="Validate" />
		...
		<script type="text/javascript" language="javascript">
			var curve1 = [[1,3],[2,7],[3,9],[4,1],[5,4],[6,6],[7,8],[8,2],[9,5],[10,1],[11,8],[12,3]];
			//var curve2 = [[1, 100], [2, 92], [3, 110], [4, 130], [5, 144]];
			//var curve3 = [[1,51],[2,56],[3,88],[4,92]];
			var serie = [curve1];
