...
<link href="/lib/jquery/datebox/jqm-datebox-1.1.0.min.css"
	rel="stylesheet" />
...
<!--  SimpleDialog -->
<script
	src="/lib/jquery/simpledialog/jquery.mobile.simpledialog2.min.js"></script>
<link href="/lib/jquery/simpledialog/jquery.mobile.simpledialog.min.css"
	rel="stylesheet" />
...
<body>
	...
	function tab_bar_main($activeTab, $opts=1) {
		...
		if ($_SESSION[EXTENDED_PROFILE] instanceof ProfileNiceBenevolat){
			...
			$arrayProfile=array("?action=main","Admin","user");
			$arrayCandidat=array("?action=infosAdmin","Infos","user");
		}
	...
	<div data-role="header" data-theme="b" data-position="fixed">
		...
		<a href="/application/myMed"
			style="position: absolute; margin-top: -3px; left: 5px;"
			data-role="button" rel="external" data-icon="fahome"
			data-iconpos="notext" data-theme="e">myMed</a>
		<? } else { ?>
		<a href="?action=logout"
			style="position: absolute; margin-top: -3px; left: 5px;"
			data-inline="true" rel="external" data-role="button" data-theme="r"
			data-icon="signout" data-iconpos="notext">Deconnexion</a>
		<? } ?>

		<h1>
			<a href="./" title="<?= APPLICATION_NAME ?>" data-inline="true"
				style="text-decoration: none; color: white;"><?= APPLICATION_NAME ?>
				<span style="font-size: 80%;"><?= APPLICATION_LABEL ?> </span> </a>
		</h1>
		<span style="position: absolute; right: 3px; top: -3px; opacity: 0.6;">
			<a class="social" style="background-position: -33px 0px;"
			href="https://plus.google.com/u/0/101253244628163302593/posts"
			title="myBenevolat on Google+"></a> <a class="social"
			style="background-position: -66px 0px;"
			href="http://www.facebook.com/pages/myEurope/274577279309326"
			title="myBenevolat on Facebook"></a> <a class="social"
			style="background-position: 0px 0px;"
			href="https://twitter.com/my_europe" title="myBenevolat on Twitter"></a>
		</span>
	</div>
