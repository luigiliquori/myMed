...
<div id="profile" data-role="page" data-dom-cache="true">
	...
	<div data-role="content">
		...
		<ul data-role="listview" data-mini="true">
			...
			<li data-icon="refresh">
				<a href="#updateProfile">
				<img class="ui-li-mymed" alt="eMail: " src="<?= APP_ROOT ?>/img/email_icon.png" width="50" Style="margin-left: 5px; top:5px;"/>
				Email<p><?= $_SESSION['user']->email ?></p></a>
			</li>
			<li data-icon="refresh">
				<a href="#updateProfile">
				<img class="ui-li-mymed" alt="Date de naissance: " src="<?= APP_ROOT ?>/img/birthday_icon.png" width="50" Style="margin-left: 5px; top:5px;"/>
				Date de naissance<p><?= $_SESSION['user']->birthday ?></p></a>
			</li>
			<li data-icon="refresh">
				<a href="#updateProfile">
				<img class="ui-li-mymed" alt="Langue: " src="<?= APP_ROOT ?>/img/<?= $_SESSION['user']->lang ?>_flag.png" width="50" Style="margin-left: 5px; top:5px;"/>
				Langue<p><?= $_SESSION['user']->lang ?></p></a>
			</li>
				...
				<?php if ($status == "on") { ?>
					<li data-icon="user" >
						<a href="<?= APP_ROOT ?>/../<?= $applicationName ?>/index.php?action=extendedProfile" rel="external">
			    			<img class="ui-li-mymed" alt="<?= $applicationName ?>" src="../../application/<?= $applicationName ?>/img/icon.png" width="50" Style="margin-left: 5px; top:5px;"/>
						    	<?= $applicationName ?>
