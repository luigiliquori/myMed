...
/** 
 * THIS DUPLICATE CLASS IS THE SAME AS THE DEFINED IN MYBENEVALAT, BUT IT
 * IS REQUIRED IN THE DELETE PROFILE FUNCTIONS TO DISTINGUISH IT FROM
 * Apply() CLASSES PRESENT IN OTHER APPLICATIONS
 * 
 * 
 */
class myBenevolatApply extends GenericDataBean {
