	...
	protected /*void*/ function getPublishFeature() { ?>
		...
		<div data-role="collapsible">
			...
			<div data-role="collapsible" data-theme="c" data-content-theme="c" data-inline="true">
			   ...
			   <label for="VIEW_2_PUBLISH_keyword">Mot Cléf</label>
			   <input type="range" name="VIEW_2_PUBLISH_keyword" id="VIEW_2_PUBLISH_keyword" value="1" min="0" max="3" />
			   <label for="VIEW_2_PUBLISH_address">Adresse (position GPS) :</label>
			   <input type="range" name="VIEW_2_PUBLISH_address" id="VIEW_2_PUBLISH_address" value="1" min="0" max="3" />
			   <label for="VIEW_2_PUBLISH_date">Date :</label>
			   <input type="range" name="VIEW_2_PUBLISH_date" id="VIEW_2_PUBLISH_date" value="1" min="0" max="3" />
			</div>
		</div>
	<?php }
	...
	protected /*void*/ function getSubscribeFeature() { ?>
		...
		<div data-role="collapsible">
			...
			<div data-role="collapsible" data-theme="c" data-content-theme="c" data-inline="true">
			   <h3>Options Avancées</h3>
			   <h4>Nombre d'ontologies</h4>
			   <label for="VIEW_2_SUBSCRIBE_keyword">Mot Cléf</label>
			   <input type="range" name="VIEW_2_SUBSCRIBE_keyword" id="VIEW_2_SUBSCRIBE_keyword" value="1" min="0" max="3" />
			   <label for="VIEW_2_SUBSCRIBE_address">Adresse (position GPS) :</label>
			   <input type="range" name="VIEW_2_SUBSCRIBE_address" id="VIEW_2_SUBSCRIBE_address" value="1" min="0" max="3" />
			   <label for="VIEW_2_SUBSCRIBE_date">Date :</label>
			   <input type="range" name="VIEW_2_SUBSCRIBE_date" id="VIEW_2_SUBSCRIBE_date" value="1" min="0" max="3" />
			</div>
		</div>
	<?php }
	...
	protected /*void*/ function getFindFeature() { ?>
		...
		<div data-role="collapsible">
			...
			<div data-role="collapsible" data-theme="c" data-content-theme="c" data-inline="true">
			   <h3>Options Avancées</h3>
			   <h4>Nombre d'ontologies</h4>
			   <label for="VIEW_2_FIND_keyword">Mot Cléf</label>
			   <input type="range" name="VIEW_2_FIND_keyword" id="VIEW_2_FIND_keyword" value="1" min="0" max="3" />
			   <label for="VIEW_2_FIND_address">Adresse (position GPS) :</label>
			   <input type="range" name="VIEW_2_FIND_address" id="VIEW_2_FIND_address" value="1" min="0" max="3" />
			   <label for="VIEW_2_FIND_date">Date :</label>
			   <input type="range" name="VIEW_2_FIND_date" id="VIEW_2_FIND_date" value="1" min="0" max="3" />
			</div>
		</div>
	<?php }
