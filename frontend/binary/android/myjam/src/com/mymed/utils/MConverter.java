...
public final class MConverter {
	 ...
	 */
	public static ByteBuffer stringToByteBuffer(final String string) throws InternalClientException {
		...
		try {
			...
			throw new InternalClientException("Wrong encoding used in the message");
		}
	 ...
	 *             used
	 */
	public static List<ByteBuffer> stringToByteBuffer(final List<String> list) throws InternalClientException {
	 ...
	 */
	public static String byteBufferToString(final ByteBuffer buffer) throws InternalClientException {

		if (buffer == null) {
			throw new InternalClientException("You need to provide a non-null value");
		}
