...
class Connection:
    ...
    def post(self, resource, args = None, filename=None, headers={}):
        return self.request(resource, "post", None , body = urllib.urlencode(args), filename=filename, headers=headers)
