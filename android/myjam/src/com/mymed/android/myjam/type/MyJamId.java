...
public class MyJamId {
	...
	private final static short LONG_BYTESIZE = 8;
	private final static short CHAR_BYTESIZE = 2;
	private final static char separationChar = '.';
	...
	public boolean equals(Object arg0){
		try{
			MyJamId myJamT = (MyJamId)arg0;
			if (this.getTimestamp()==myJamT.getTimestamp() &&
					this.getType() == myJamT.getType() &&
						this.getUserId().equals(myJamT.getUserId()))
				return true;
			else
				return false;
		}catch(Exception e){
