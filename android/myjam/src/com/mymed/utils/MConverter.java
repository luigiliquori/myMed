...
public final class MConverter {
	 ...
	 */
	public static ByteBuffer stringToByteBuffer(final String string) throws Exception {

		if (string == null) {
			throw new Exception("You need to provide a non-null value");
		}
		...
		try {
			...
			throw new Exception("Wrong encoding used in the message");
		}
	 ...
	 *             used
	 */
	public static List<ByteBuffer> stringToByteBuffer(final List<String> list) throws Exception {
	 ...
	 */
	public static String byteBufferToString(final ByteBuffer buffer) throws Exception {
