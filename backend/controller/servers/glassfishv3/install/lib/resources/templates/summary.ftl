...
<body topmargin="12" leftmargin="12" rightmargin="12" bgcolor="#ffffff" marginheight="12" marginwidth="12">
  ...
  <h2><a name="section-InstallationSummary"> Install Summary for ${summary.productname}</a></h2>
  </#if>
...
<h2><a name="section-InstallationSummary"> Uninstall Summary for ${summary.productname}</a></h2>
  </#if>
...
<#if (summary.totalinstallcount > 0)>  <b>${summary.fullyinstalledcount} of ${summary.totalinstallcount} components were completely installed</b>. </#if>
<#if (summary.totalrepaircount > 0)>  <b>${summary.fullyrepairedcount} of ${summary.totalrepaircount} components were completely repaired</b>. </#if>
<#if (summary.totalconfigcount > 0)>  <b>${summary.fullyconfiguredcount} of ${summary.totalconfigcount} components were completely configured</b>. </#if>
<#if (summary.totaluninstallcount > 0)>  <b>${summary.fullyuninstalledcount} of ${summary.totaluninstallcount} components were removed completely</b>. </#if>
<#if (summary.totalunconfigcount > 0)>  <b>${summary.fullyunconfiguredcount} of ${summary.totalunconfigcount} components were completely unconfigured</b>. </#if>
...
<#if (summary.componentstoconfigure?size > 0)>
<h3><a name="section-NextStepsReport">Next Steps for using ${summary.productname}</a></h3>
<table class="wikitable" border="1">
