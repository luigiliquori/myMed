package com.mymed.controller.core.manager.locator;
 ...
 *
 */
public class LocatorManager extends AbstractManager {

	public LocatorManager() throws InternalBackEndException {
		this(new MyJamStorageManager());
	}

	public LocatorManager(final MyJamStorageManager storageManager) throws InternalBackEndException {
	...
	public MSearchBean read(final String applicationId, final String objType, final long locationId, final String objId) 
		...
		try {
			ExpColumnBean expCol = myJamStorageManager.selectExpiringColumn("Location", applicationId+objType+areaId, 
					...
					MyMedId.parseString(objId).ReportIdAsByteBuffer().array());
