...
public class JsonMessageOut<T> {
	 ...
	 */
	public JsonMessageOut(final int status, final String handler) {
	 ...
	 */
	public JsonMessageOut(final int status, final String handler,
			final String method, final Map<String, String> data,
			final Map<String, T> dataObject) {
		this.status = status;
