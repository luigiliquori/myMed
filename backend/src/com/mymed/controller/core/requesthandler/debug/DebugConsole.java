...
public class DebugConsole extends AbstractRequestHandler {
      ...
      if (parameters.containsKey("act")) {
        ...
        switch (chx) {
          ...
          case INSERTKEY :
            ...
            cassandraClient.insert(MConverter.stringToByteBuffer(keyUserID), parent, column, ConsistencyLevel.ONE);
  ...
  protected void processRequest(final HttpServletRequest request, final HttpServletResponse response)
    ...
    try {
      ...
      // STATUS
          + "<b>Status:</b><br />" + "<span style='color: green;'>connected</span> on: "
          + address
          + ":"
          + port
          + "<br />"
          ...
          + "</form>"
          // SETKEYUSERID
          + "<form>" + "<input type='hidden' name='act' value='"
          + SETKEYUSERID
          + "' />"
          ...
          + "</form>"
          // INSERTKEY
          + "<form>" + "<input type='hidden' name='act' value='" + INSERTKEY + "' />"
          + "<input type='submit' value='Insert' /> (" + "<input name='key1' type='text' value='columnName' />, "
          + "<input name='value1' type='text' value='value'/> )"
          + "</form>"
          // GETKEY
          + "<form>" + "<input type='hidden' name='act' value='" + GETKEY + "' />"
          + "<input type='submit' value='Get' /> (" + "<input name='key2' type='text' value='columnName' /> )"
          + "</form>");
