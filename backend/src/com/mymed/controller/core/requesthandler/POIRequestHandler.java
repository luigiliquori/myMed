	...
	IOException {
		...
		try {
			...
			case READ : // GET
				...
				// GET THE POIs
				List<MSearchBean> pois = geoLocationManager.read(application, type, convertDegreeToMicroDegree(latitude), convertDegreeToMicroDegree(longitude), Integer.parseInt(radius),false);
