...
public class MyJamManagerTest extends TestCase{
	...
	public void testSearch(){
		...
		try{
			listSearchRep = this.manager.searchReports((int) (centerLat*1E6),(int) (centerLon*1E6), meterRange);
			...
			for (int i=0;i<NUM_INSERTIONS;i++){
				...
				MReportBean repB = this.manager.insertReport(generateReport(rand), (int) (lat*1E6), (int) (lon*1E6));
    ...
    public void testGetReport(){
		...
		try {
	        ...
	        MReportBean repRes = this.manager.insertReport(generateReport(rand),(int) (centerLat*1E6), (int) (centerLon*1E6));
