...
/**
 * Class used to identify a report. Format of the identifier: -Textual representation: <char><userId>_<timestamp> -Raw
 * bytes representation: <char(2 Bytes)><timestamp(8 Bytes)><userId(1 Byte for each character)>
 * 
 * @author iacopo
 */
