...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/iceintegration

dist/Release/GNU-Linux-x86/iceintegration: ${OBJECTFILES}
...
${OBJECTDIR}/IceWrapper.o: IceWrapper.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/IceWrapper.o IceWrapper.cpp
...
${OBJECTDIR}/JavaIceWrapper.o: JavaIceWrapper.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/JavaIceWrapper.o JavaIceWrapper.cpp
...
${OBJECTDIR}/MovingBuffer.o: MovingBuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/MovingBuffer.o MovingBuffer.cpp

${OBJECTDIR}/EventLogger.o: EventLogger.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/EventLogger.o EventLogger.cpp
...
${OBJECTDIR}/IceConnection.o: IceConnection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/IceConnection.o IceConnection.cpp

${OBJECTDIR}/PseudoTcpTx.o: PseudoTcpTx.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/PseudoTcpTx.o PseudoTcpTx.cpp

${OBJECTDIR}/PseudoTcpRx.o: PseudoTcpRx.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/PseudoTcpRx.o PseudoTcpRx.cpp

${OBJECTDIR}/PseudoTcpUtil.o: PseudoTcpUtil.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/PseudoTcpUtil.o PseudoTcpUtil.cpp

${OBJECTDIR}/MessageDispatcher.o: MessageDispatcher.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/MessageDispatcher.o MessageDispatcher.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/iceintegration
